...
from helper_functions.tab2 import interactive_charts_tab_editor3
...
from helper_functions.utils import load_file, display_logo, page_navigations, normalize_column_names, process_file
...
if uploaded_files:
    ...
    if df.empty:
        ...
        with tab2:
            try:
                generated_figures = interactive_charts_tab_editor3(updated_df)
